...
class TownPopulationsSpec extends DataCorrectnessSpec{

  override def expectedNbOfRows: Long = 2172

  override val datasetInterface: DatasetInterface = TownPopulations()

  override def nonNullColumns = Set(s.population)
}
