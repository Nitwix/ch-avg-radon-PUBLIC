...
class AverageFloor2004Spec extends DataCorrectnessSpec {

  override def expectedNbOfRows: Long = 26

  override val datasetInterface: DatasetInterface = AverageFloor2004()
  ...
  "toMap" should "contain entries with correct values for NE, TI, BE" in {
    val avgFloorMap = AverageFloor2004().toMap
    assertResult(1.57)(avgFloorMap("NE"))
    assertResult(1.29)(avgFloorMap("TI"))
    assertResult(1.11)(avgFloorMap("BE"))
  }
}
